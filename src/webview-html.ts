    ...
    <div class="workshop">
      ...
      <div id="canvas" class="canvas">
        ...
        <div class="canvas-controls canvas-controls--right" role="toolbar">
          ...
          <button id="auto-route" class="canvas-controls__btn canvas-controls__btn--icon" title="${l10n.t('Auto-route the wires (right angles) — selection, or whole diagram. Ctrl+click: erase the bends and re-route from scratch')}"><img class="canvas-controls__icon" src="${autoRouteUri}" alt="${l10n.t('Auto-route the wires (right angles) — selection, or whole diagram. Ctrl+click: erase the bends and re-route from scratch')}" /></button>
